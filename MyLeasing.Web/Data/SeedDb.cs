...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Santiago", "Acuña", "snt-26@hotmail.com", "321 777 5042", "Carrera 8i # 66bn-38", "Manager");
            var owner = await CheckUserAsync("2020", "Santiago", "Acuña", "snt-26@gmail.com", "321 777 5042", "Carrera 8i # 66bn-38", "Owner");
            var lessee = await CheckUserAsync("3030", "Santiago", "Acuña", "snt-26@unicauca.com", "321 777 5042", "Carrera 8i # 66bn-38", "Lessee");
        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    "sed cursus sem tincidunt ut. Nullam metus lorem, convallis quis dignissim quis, porttitor " +
                    "quis leo. In hac habitasse platea dictumst. Duis pharetra sed arcu ac viverra. Proin dapibus " +
                    "lobortis commodo. Vivamus non commodo est, ac vehicula augue. Nam enim felis, rutrum in tortor" +
                    " sit amet, efficitur hendrerit augue. Cras pellentesque nisl eu maximus tempor. Curabitur eu " +
                    "efficitur metus. Sed ultricies urna et auctor commodo."
                });
